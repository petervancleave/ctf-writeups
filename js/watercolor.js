class WatercolorEffect {
    constructor() {
        ...
        this.colors = [
            { r: 147, g: 51, b: 234, a: 0.12 },  // Vibrant Purple
            { r: 236, g: 72, b: 153, a: 0.12 },  // Hot Pink
            { r: 167, g: 139, b: 250, a: 0.12 }, // Periwinkle
            { r: 248, g: 113, b: 113, a: 0.12 }, // Coral
            { r: 129, g: 140, b: 248, a: 0.12 }, // Royal Blue
            { r: 217, g: 70, b: 239, a: 0.12 }   // Magenta
        ];
        this.baseColors = [
            { r: 147, g: 51, b: 234, a: 0.08 },   // Base Purple
            { r: 236, g: 72, b: 153, a: 0.08 },   // Base Pink
            { r: 129, g: 140, b: 248, a: 0.08 }   // Base Blue
        ];
        this.lastTime = 0;
        this.colorTransitionProgress = 0;
        this.currentColorIndex = 0;
        this.colorOffset = 0; // New: For smooth color cycling
        this.init();
    }
